      ...
      body.innerHTML =
        '<div style="display:flex;align-items:center;justify-content:center;">'+
          '<div class="die-wrap"><div class="die-name">'+des.players[0]+'</div>'+desDieHTML(d1,false)+
            '<div style="font-family:Unbounded,sans-serif;font-size:28px;margin-top:6px;">'+d1+'</div></div>'+
          '<div class="die-vs">=</div>'+
          '<div class="die-wrap"><div class="die-name">'+des.players[1]+'</div>'+desDieHTML(d2,false)+
            '<div style="font-family:Unbounded,sans-serif;font-size:28px;margin-top:6px;">'+d2+'</div></div>'+
        '</div>'+
        '<div style="font-family:Unbounded,sans-serif;font-size:24px;color:var(--accent);margin-top:16px;">Égalité !</div>'+
        '<div style="font-size:14px;color:var(--text-dim);margin-top:6px;">On relance...</div>';
    ...
    body.innerHTML =
      '<div style="display:flex;align-items:center;justify-content:center;">'+
        ...
        '<div class="die-wrap"><div class="die-name" style="color:'+(loser===1?'var(--clay)':'var(--sage)')+';">'+des.players[1]+'</div>'+desDieHTML(d2,false)+
          '<div style="font-family:Unbounded,sans-serif;font-size:28px;margin-top:6px;">'+d2+'</div></div>'+
      '</div>'+
      '<div style="font-family:Unbounded,sans-serif;font-size:28px;color:var(--clay);margin-top:20px;">'+des.players[loser]+' perd</div>'+
      '<div style="font-family:Unbounded,sans-serif;font-size:22px;color:var(--text);margin-top:8px;">'+product+' gorgée'+(product>1?'s':'')+'</div>';
